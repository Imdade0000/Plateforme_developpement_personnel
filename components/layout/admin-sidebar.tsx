...
export function AdminSidebar() {
  ...
  const desktopNav = (
    <nav className="hidden md:block w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white p-6 shadow-2xl border-r border-gray-700">
      {/* Header avec dégradé */}
      <div className="mb-8 p-6 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl shadow-lg">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="font-bold text-lg">Espace Créateur</p>
            <p className="text-blue-100 text-sm font-medium">Administrateur</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="pt-6">
          <p className="px-3 text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wider">Votre Contenu</p>
          <div className="space-y-1">
            ...
            <NavLink href="/admin/content/new" icon={
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6">
          <p className="px-3 text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wider">Analytics</p>
          <div className="space-y-1">
            ...
            <NavLink href="/admin/reports" icon={
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6">
          <p className="px-3 text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wider">Gestion</p>
          <div className="space-y-1">
            ...
            <NavLink href="/admin/settings" icon={
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
      ...
      <div className="absolute bottom-6 left-6 right-6">
        <div className="bg-gray-700/50 backdrop-blur-sm rounded-xl p-4 border border-gray-600">
          <p className="text-xs text-gray-300 text-center">
            Plateforme Développement Personnel
          </p>
        </div>
      </div>
    </nav>
